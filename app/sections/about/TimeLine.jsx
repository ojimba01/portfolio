...
const TimeLineData = [
	{ year: 2023, text: "Start a Full-Stack Software Engineer Internship @TRHC" },
	{ year: 2022, text: "Start a Software Engineer Internship @TRHC" },
	{ year: 2022, text: "Start a QA Automation Engineer Internship @SHI International" },
	{ year: 2019, text: "Begin College and pursue Computer Science" },
	{ year: 2018, text: "Pick up python for the first time" }
];
